...
const typeMeta = {
  ...
  event: { icon: CalendarDays, color: C.sky, label: "Event" },
  alert: { icon: AlertTriangle, color: C.coral, label: "Alert" },
  general: { icon: Megaphone, color: C.violet, label: "General" },
};
  ...
  return (
    <div style={{ animation: "fadeIn 0.4s ease" }}>
      <div style={{ marginBottom: 20 }}>
        ...
        <h1 style={{ fontFamily: fontDisplay, fontWeight: 700, fontSize: 26, color: C.ink, margin: "4px 0 0" }}>Notifications</h1>
      </div>
